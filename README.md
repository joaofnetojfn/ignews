...
# João Ferreira Neto - Aluno do IGNITE </h1>
  ...
  &nbsp;
  <h4 align="center"> 
	Site de Posts onde para ver todo o post tem que ser cadastrado e ter pago mensalidade. -> Com login pelo usuario do gitHub
    -> Atenticação nextAuth
    -> Stripe para criar e passar a compra
    -> Fauna banco de Dados
  </h4>
...
* Web Site que buscar do Stripe o preço do produto, ao logar na plataforma ele salva os dados no FaunaDb para que a pessoa pode ter acesso a todo o post.

# :construction_worker: Como rodar
```bash
# Clone o Repositoria
$ git clone https://github.com/joaofnetojfn/ignews
